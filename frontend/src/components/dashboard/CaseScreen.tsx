...
export default function CaseScreen({ caseId }: CaseScreenProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-4 overflow-x-hidden overflow-y-auto bg-white p-3 sm:p-4 lg:grid lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:overflow-hidden xl:gap-5 xl:p-5">
