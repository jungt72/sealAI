...
test("workspace path builders keep RFQ reads on BFF and legacy dispatch disabled", async () => {
  ...
  assert.deepEqual(exportedKeys, [
    ...
    "buildRwdrAnalyzeBackendPath",
    "buildRwdrAnalyzeReadPath",
    "buildRwdrBriefBackendPath",
    "buildRwdrBriefReadPath",
    "buildRwdrCaseBackendPath",
    "buildRwdrCaseBriefBackendPath",
    "buildRwdrCaseBriefReadPath",
    "buildRwdrCaseDiffBackendPath",
    "buildRwdrCaseDiffReadPath",
    "buildRwdrCaseExportBackendPath",
    "buildRwdrCaseExportReadPath",
    "buildRwdrCasePdfBackendPath",
    "buildRwdrCasePdfReadPath",
    "buildRwdrCaseReadPath",
    "buildRwdrCaseSnapshotsBackendPath",
    "buildRwdrCaseSnapshotsReadPath",
    "buildRwdrConfirmationsBackendPath",
