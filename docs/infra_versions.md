...
Generated: 2025-12-27 15:10:27 UTC
...
backend             sealai-backend:dev                       "uvicorn app.main:ap…"   backend             2 hours ago         Up 2 hours (healthy)      0.0.0.0:8000->8000/tcp, :::8000->8000/tcp
frontend            sealai-frontend                          "docker-entrypoint.s…"   frontend            2 hours ago         Up 2 hours (healthy)      0.0.0.0:3000->3000/tcp, :::3000->3000/tcp
keycloak            ghcr.io/jungt72/sealai-keycloak:latest   "/opt/keycloak/bin/k…"   keycloak            2 hours ago         Up 2 hours                8443/tcp, 0.0.0.0:8080->8080/tcp, :::8080->8080/tcp, 9000/tcp
nginx               nginx:latest                             "/docker-entrypoint.…"   nginx               2 hours ago         Up 2 hours (healthy)      0.0.0.0:80->80/tcp, :::80->80/tcp, 0.0.0.0:443->443/tcp, :::443->443/tcp
postgres            postgres:15                              "docker-entrypoint.s…"   postgres            2 hours ago         Up 2 hours (healthy)      5432/tcp
qdrant              qdrant/qdrant:v1.16.0                    "./entrypoint.sh"        qdrant              12 seconds ago      Up 11 seconds             0.0.0.0:6333-6334->6333-6334/tcp, :::6333-6334->6333-6334/tcp
redis               redis/redis-stack-server:7.4.0-v8        "/entrypoint.sh"         redis               12 seconds ago      Up 11 seconds (healthy)   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp
```
### docker ps
```
CONTAINER ID   IMAGE                                    COMMAND                  CREATED          STATUS                    PORTS                                                                          NAMES
d4518223b4de   qdrant/qdrant:v1.16.0                    "./entrypoint.sh"        12 seconds ago   Up 11 seconds             0.0.0.0:6333-6334->6333-6334/tcp, [::]:6333-6334->6333-6334/tcp                qdrant
02968a62cfb8   redis/redis-stack-server:7.4.0-v8        "/entrypoint.sh"         12 seconds ago   Up 11 seconds (healthy)   0.0.0.0:6379->6379/tcp, [::]:6379->6379/tcp                                    redis
...
qdrant/qdrant                     v1.16.0    708514cec931   5 weeks ago    198MB
redis/redis-stack-server          7.4.0-v8   3b02c41b1595   7 weeks ago    520MB
...
- Notes: first attempt failed: psql: error: connection to server on socket "/var/run/postgresql/.s.PGSQL.5432" failed: FATAL:  role "postgres" does not exist

### Qdrant
- Container: qdrant
- Image: qdrant/qdrant:v1.16.0
- Ports: 0.0.0.0:6333-6334->6333-6334/tcp, [::]:6333-6334->6333-6334/tcp
- Running version: 1.16.0
...
- Service defined in compose: no

## Run History
- Run: 2025-12-27 15:10:27 UTC (Host: ubuntu-8gb-nbg1-1) - Redis 7.4.7, Qdrant 1.16.0, Postgres 15.15, Keycloak 25.0.4, Strapi 5.31.0 (not running)
