...
| GWT-CERT-001 | Compliance/certificate request mentions FDA, ATEX or EU references | Checklist generated | Requirements stay evidence-needed; no approval or release claim appears | `backend/tests/unit/services/test_compliance_certificate_checklist_service.py` | P1 |
| GWT-DRAWING-001 | Drawing upload or manufacturability request | Shallow intake generated | `drawing_review` remains candidate review; no manufacturability release appears | `backend/tests/unit/services/test_shallow_mode_intake_service.py` | P1 |
| GWT-QUOTE-001 | User asks to compare offers | Shallow intake generated | `quote_comparison` avoids cheapest-option or final equivalence recommendation | `backend/tests/unit/services/test_shallow_mode_intake_service.py` | P1 |
| GWT-SUBST-001 | User asks for material substitution, e.g. PFAS-free alternative | Shallow intake generated | Substitution remains risk brief and manufacturer/compound review required | `backend/tests/unit/services/test_shallow_mode_intake_service.py` | P1 |
