...
| Material-constraint governance (03A immutable snapshots, owner-accepted 03B non-authoritative shadow/pinning, immutable 01A/B/C v1 plus additive typed-scope v2 Evidence contracts, empty MED-NORM-01 catalog, MAT-RULES-01 reviewed-pack seam plus gap-only inventory, and the separate non-human `MAT-EVID-AI-REVIEW.v1` cross-review aggregate; first RP-001 package remains `ai_draft` after two `REVIEW_INCOMPLETE` transports; default-off/sampling zero) | `docs/ssot/MATERIAL_CONSTRAINT_GOVERNANCE.md`, `docs/architecture/ADR_MAT_GOV_03A_PERSISTENCE.md`, `docs/architecture/ADR_MAT_GOV_03B_SHADOW_PINNING.md`, `docs/architecture/ADR_MAT_EVID_01A_PERSISTENCE.md`, `docs/architecture/ADR_MAT_EVID_01B_RUNTIME_BINDING.md`, `docs/architecture/ADR_MAT_EVID_01C_FACTUAL_REVIEW.md`, `docs/architecture/ADR_MAT_EVID_02_TYPED_SCOPES.md`, `docs/architecture/ADR_MED_NORM_01_CATALOG.md`, `docs/architecture/ADR_MAT_RULES_01_REVIEWED_PACK.md`, `docs/architecture/ADR_MAT_EVID_AI_REVIEW_V1.md`, `docs/ops/material-evidence-ai-review/RP-001_ELASTOMER_MEDIA_EXCLUSIONS_AI_V1/README.md`, `backend/sealai_v2/core/material_rulesets.py`, `backend/sealai_v2/core/material_shadow.py`, `backend/sealai_v2/core/material_evidence.py`, `backend/sealai_v2/core/material_evidence_v2.py`, `backend/sealai_v2/core/material_evidence_binding.py`, `backend/sealai_v2/core/material_evidence_binding_v2.py`, `backend/sealai_v2/core/material_evidence_review.py`, `backend/sealai_v2/core/material_evidence_review_v2.py`, `backend/sealai_v2/core/material_evidence_ai_review.py`, `backend/sealai_v2/core/medium_catalog.py`, `backend/sealai_v2/core/material_reviewed_rules.py`, `docs/ssot/material-rule-coverage-v1.json`; production migrations, real rule curation, ruleset activation and MAT-GOV-03C remain NO-GO |
