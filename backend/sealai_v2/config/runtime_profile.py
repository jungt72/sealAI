...
_NON_BEHAVIOR_FIELDS = frozenset(
    {
        ...
        "auth_audience",
        "auth_tenant_claim",
        "auth_tenant_admin_role",
        "auth_platform_owner_role",
        "auth_system_operator_role",
        "auth_knowledge_contributor_role",
        "auth_knowledge_reviewer_role",
        "auth_knowledge_approver_role",
