...
LLM_REGISTRY: Final[Dict[str, str]] = {
    ...
    "gate": "gpt-4o-mini",
    "routing": "gpt-4o-mini",
    "semantic_intent_router": "gpt-4o-mini",
    "communication_runtime": "gpt-4o-mini",
    "exploration": "gpt-4o-mini",
    "conversation": "gpt-4o-mini",
    "knowledge_answer_composer": "gpt-4o-mini",
    "governed_answer_composer": "gpt-4o-mini",
    "governed_reformulate": "gpt-4o-mini",
    "medium_intelligence": "gpt-4o-mini",
    "medium_answer_composer": "gpt-4o-mini",
    "medium_fallback": "gpt-4o-mini",
    "medium_web_research": "gpt-4o-mini",
...
ROLE_ENV_MAPPING: Final[Dict[str, str]] = {
    ...
    "semantic_intent_router": "OPENAI_ROUTER_MODEL",
    "communication_runtime": "SEALAI_COMMUNICATION_RUNTIME_MODEL",
    "exploration": "SEALAI_EXPLORATION_MODEL",
    "conversation": "SEALAI_CONVERSATION_MODEL",
    "knowledge_answer_composer": "SEALAI_KNOWLEDGE_ANSWER_COMPOSER_MODEL",
    "governed_answer_composer": "SEALAI_GOVERNED_ANSWER_COMPOSER_MODEL",
    "governed_reformulate": "SEALAI_CONVERSATION_MODEL",
    "medium_intelligence": "SEALAI_MEDIUM_INTELLIGENCE_MODEL",
    "medium_answer_composer": "SEALAI_MEDIUM_ANSWER_COMPOSER_MODEL",
    "medium_fallback": "SEALAI_MEDIUM_FALLBACK_MODEL",
    "medium_web_research": "SEALAI_MEDIUM_WEB_RESEARCH_MODEL",
