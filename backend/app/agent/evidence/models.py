...
class Claim(BaseModel):
    ...
    claim_type: ClaimType = Field(
        ..., description="Die Kategorie der fachlichen Aussage."
    )
    statement: str = Field(
        ..., min_length=5, description="Die eigentliche fachliche Erkenntnis."
    )
    confidence: float = Field(
        ..., ge=0.0, le=1.0, description="Konfidenzlevel der Aussage (0.0 - 1.0)."
    )
