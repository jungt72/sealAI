...
def test_selection_reexports_split_module_symbols() -> None:
    assert (
        selection.build_clarification_projection
        is clarification.build_clarification_projection
    )
    ...
    assert (
        selection.build_output_contract_projection
        is projections_extended.build_output_contract_projection
    )
