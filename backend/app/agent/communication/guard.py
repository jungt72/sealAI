...
class CommunicationGuard:
    ...
    _allowed_proposal_units: dict[str, set[str | None]] = {
        ...
        "pressure_mpa": {"MPa", "mpa", None},
        "pressure_spike_bar": {"bar", None},
        "decompression_rate_bar_per_s": {"bar/s", None},
        "temperature_c": {"degC", "c", "°c", None},
        "temperature_min_c": {"degC", "c", "°c", None},
        "temperature_max_c": {"degC", "c", "°c", None},
        "radial_gap_mm": {"mm", None},
        "groove_width_mm": {"mm", None},
        "groove_depth_mm": {"mm", None},
        "cross_section_mm": {"mm", None},
        "seal_inner_diameter_mm": {"mm", None},
        "runout_um": {"um", "µm", None},
        "surface_roughness_ra_um": {"um", "µm", None},
        "surface_roughness_rz_um": {"um", "µm", None},
        "hardness_shore_a": {"Shore A", "shore a", None},
        "medium": {None},
        "leakage_target": {None},
        "target_lifetime_cycles": {"cycles", None},
        "target_lifetime_hours": {"h", None},
        "motion_type": {None},
        "seal_type": {None},
        "damage_pattern": {None},
    }
