...
CHAT_TEMPLATE_REGISTRY: dict[ChatReplyStyle, ChatTemplateMeta] = {
    ...
    "knowledge_explainer": ChatTemplateMeta(
        ...
        path="knowledge/knowledge_explainer.j2",
        style="knowledge_explainer",
        allowed_modes=("knowledge_general",),
        max_questions=1,
        disclaimer_policy="suppress_normal_turn",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("definition", "practical_relevance", "bounded_summary"),
    ),
    "case_aware_explainer": ChatTemplateMeta(
        template_id="chat.case_aware_explainer.v1",
        path="knowledge/case_aware_knowledge.j2",
        style="case_aware_explainer",
        allowed_modes=("knowledge_case_aware",),
        max_questions=1,
        disclaimer_policy="suppress_normal_turn",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("case_relevance", "decisive_factors", "review_note"),
    ),
    "measurement_guide": ChatTemplateMeta(
        template_id="chat.measurement_guide.v1",
        path="knowledge/measurement_guide.j2",
        style="measurement_guide",
        allowed_modes=("measurement_guidance",),
        max_questions=1,
        disclaimer_policy="suppress_normal_turn",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("measurement_intro", "measurement_steps", "action_chips"),
    ),
    "ui_help": ChatTemplateMeta(
        template_id="chat.ui_help.v1",
        path="chat/ui_help.j2",
        style="ui_help",
        allowed_modes=("ui_help",),
        max_questions=1,
        disclaimer_policy="ui_static_only",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("help_text", "follow_up"),
    ),
    "sheet_comment": ChatTemplateMeta(
        template_id="chat.sheet_comment.v1",
        path="chat/sheet_comment.j2",
        style="sheet_comment",
        allowed_modes=("sheet_field_edit", "sheet_bulk_input"),
        max_questions=1,
        disclaimer_policy="suppress_normal_turn",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("acknowledgement", "relevant_consequence"),
    ),
    "conflict_resolution": ChatTemplateMeta(
        template_id="chat.conflict_resolution.v1",
        path="chat/conflict_resolution.j2",
        style="conflict_resolution",
        allowed_modes=("sheet_conflict_resolution",),
        max_questions=1,
        disclaimer_policy="suppress_normal_turn",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("conflict_statement", "resolution_question"),
    ),
    "rfq_confirmation": ChatTemplateMeta(
        template_id="chat.rfq_confirmation.v1",
        path="rfq/rfq_confirmation.j2",
        style="rfq_confirmation",
        allowed_modes=("rfq_brief_generation",),
        max_questions=1,
        disclaimer_policy="rfq_required",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("confirmation", "open_points_note", "confirm_question"),
    ),
    "rfq_one_pager_intro": ChatTemplateMeta(
        template_id="chat.rfq_one_pager_intro.v1",
        path="rfq/rfq_one_pager_intro.j2",
        style="rfq_one_pager_intro",
        allowed_modes=("rfq_brief_generation",),
        max_questions=1,
        disclaimer_policy="rfq_required",
        forbidden_phrases=FORBIDDEN_NORMAL_TURN_PHRASES,
        required_fields=("intro", "scope_note"),
    ),
}
