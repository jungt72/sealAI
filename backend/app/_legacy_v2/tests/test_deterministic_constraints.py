import pytest
from app._legacy_v2.nodes.reasoning_core_node import _build_system_prompt
from app._legacy_v2.nodes.conversational_rag import _build_engineering_physics_report
from app._legacy_v2.state import SealAIState, LiveCalcTile
