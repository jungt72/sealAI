from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_resistance_claims
from app._legacy_v2.state.sealai_state import ConflictRecord
...
def test_scope_conflict_detection_heuristic() -> None:
    ...
    from app._legacy_v2.state.sealai_state import SealAIState, AnswerContract, VerificationReport
    from app._legacy_v2.nodes.answer_subgraph.state import AnswerSubgraphState
...
def test_parameter_conflict_pressure_mismatch_generates_conflict() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_parameter_conflicts
    from app._legacy_v2.state.sealai_state import AnswerContract
...
def test_blocking_unknown_pressure_missing_in_contract_but_claimed_in_draft() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_blocking_unknowns
    from app._legacy_v2.state.sealai_state import AnswerContract
...
def test_compound_specificity_conflict_grade_jump_generates_conflict() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_specificity_conflicts
    from app._legacy_v2.state.sealai_state import AnswerContract
...
def test_condition_conflict_detection_missing_parameters() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_condition_conflicts
    from app._legacy_v2.state.sealai_state import AnswerContract, RequirementSpec
...
def test_assumption_conflict_detection_limited_evidence() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_assumption_conflicts
    from app._legacy_v2.state.sealai_state import AnswerContract, GovernanceMetadata
...
def test_temporal_validity_conflict_detection() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_temporal_validity_conflicts
    from app._legacy_v2.state.sealai_state import AnswerContract, GovernanceMetadata
...
def test_scope_conflict_detects_vague_language() -> None:
    from app._legacy_v2.nodes.answer_subgraph.node_verify_claims import _check_scope_conflicts
    from app._legacy_v2.state.sealai_state import AnswerContract
