...
import pytest
from app._legacy_v2.nodes.answer_subgraph.node_finalize import _build_rfq_draft
from app._legacy_v2.utils.redaction import redact_operating_context
from app._legacy_v2.state.sealai_state import SealAIState, SealingRequirementSpec, AnswerContract, RFQDraft
...
def test_redaction_allowlist_completeness():
    ...
    from app._legacy_v2.utils.redaction import _RFQ_REDACTION_ALLOWLIST
