...
from app._legacy_v2.nodes.answer_subgraph.node_draft_answer import (
...
from app._legacy_v2.state.sealai_state import AnswerContract, SealAIState, VerificationReport
from app._legacy_v2.utils.assertion_cycle import is_artifact_stale, stamp_patch_with_assertion_binding
from app._legacy_v2.utils.confirm_checkpoint import build_confirm_checkpoint_payload
