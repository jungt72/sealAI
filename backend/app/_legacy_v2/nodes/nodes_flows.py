...
from app._legacy_v2.state import CalcResults, SealAIState, Source, WorkingMemory
from app._legacy_v2.utils.jinja import render_prompt_sections, render_template
...
from app._legacy_v2.utils.rag import apply_rag_quality_gate, unpack_rag_payload
from app._legacy_v2.utils.rag_safety import wrap_rag_context
from app._legacy_v2.utils.rag_tool import search_knowledge_base
...
def rag_support_node(state: SealAIState, *_args: Any, **_kwargs: Any) -> Dict[str, Any]:
    ...
    user_text = latest_user_text(state.conversation.messages) or ""
    from app._legacy_v2.nodes.nodes_frontdoor import detect_sources_request
