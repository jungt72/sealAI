...
from app._legacy_v2.io import AskMissingRequest, CoverageAnalysis, ParameterProfile
from app._legacy_v2.state.audit import EvidenceBundle, SourceRefPayload, ToolCallRecord
from app._legacy_v2.types import (
    IntentKey,
    KnowledgeType,
    PhaseLiteral,
